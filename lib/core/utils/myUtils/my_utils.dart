...
//  }
  ...
  static String? getObscuredNumberWithSpaces({@required String? string,
...
//  );
  ...
  static showIOSAreYouSureDialog(BuildContext context, {text, VoidCallback? onClose, leftText, rightText, mainText, subtext}){
    Widget cancelButton = TextButton(
      child: Text(leftText, style: const TextStyle(color: blue),),
      onPressed:  () {
        Navigator.pop(context);
      },
    );
    Widget continueButton = TextButton(
        child: Text(rightText, style: TextStyle(color: blue),),
        onPressed: onClose
    );
  ...
  static   showAreYouSureDialog(BuildContext context, {text, VoidCallback? onClose, leftText, rightText, mainText, subtext}) {
    ...
    Widget continueButton = TextButton(
        child: Text(rightText, style: const TextStyle(color: blue),),
        onPressed: onClose
    );
